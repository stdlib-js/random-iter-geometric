...
> Create an iterator for generating pseudorandom numbers drawn from a [geometric][geometric] distribution.
...
```javascript
iterator = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-geometric@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-iter-geometric/tags). For example,

```javascript
iterator = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-geometric@v0.2.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var iterator = require( 'path/to/vendor/umd/random-iter-geometric/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-geometric@umd/browser.js"></script>
```
...
Returns an iterator for generating pseudorandom numbers drawn from a [geometric][geometric] distribution with success probability `p`.
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-iter-geometric.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-iter-geometric

[test-image]: https://github.com/stdlib-js/random-iter-geometric/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/random-iter-geometric/actions/workflows/test.yml?query=branch:v0.2.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-iter-geometric/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-iter-geometric?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-iter-geometric.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-iter-geometric/main
...
[deno-url]: https://github.com/stdlib-js/random-iter-geometric/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-iter-geometric/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-iter-geometric/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-iter-geometric/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-iter-geometric/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-iter-geometric/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-iter-geometric/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-iter-geometric/main/LICENSE
